...
///
/// A envelope that appears to be damaged, such as one with a repeated or
...
/// ```
///
/// For an example with upgradable version, see the [crate-level documentation](crate#as-upgradable-versions).
